...
const TOPIC_KEYWORDS = [
  ...
  "радіоведуч", "подкаст", "фотограф", "відеомонтаж",
...
// промислового дизайнера-конструктора виробів, і дизайнера меблів/інтер'єру;
// "комунікац" — і "оператора інформаційно-комунікаційних мереж", монтажника
// інформаційно-комунікаційного устаткування чи фахівця з техпідтримки
// електронних комунікацій (усе це IT/телеком-інфраструктура, не PR-комунікації).
const EXCLUDE_KEYWORDS = [
  "промислов", "виробнич", "інформаційно-комунікаційн", "художник-конструктор",
  "електронних комунікацій", "інтер'єру", "меблів",
];

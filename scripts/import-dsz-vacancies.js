...
// "комунікац" — і "оператора інформаційно-комунікаційних мереж" чи фахівця
// з техпідтримки електронних комунікацій (IT/телеком, не PR-комунікації).
const EXCLUDE_KEYWORDS = [
  "промислов", "виробнич", "комунікаційних мереж", "художник-конструктор",

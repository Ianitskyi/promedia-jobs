...
const VACANCIES = [
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "Єдиний портал вакансій ДСЗ", url: "https://www.dcz.gov.ua/job" },
    ],
  },
  {
    ...
    applyMethod: "external", contactEmail: "", sourceUrl: "https://www.dcz.gov.ua/job",
    publishedAt: "2026-07-21", expiresAt: "2026-08-20",
  ...
  {
    id: "v19", title: "Копірайтер(ка) медіапроєкту", companyId: null,
    companyName: "Медіакомпанія (з категорії «Медіа» на Happy Monday)",
    categories: ["content", "copywriting"], level: "middle",
    city: "Київ", country: "Україна", format: "remote", remoteOk: true, fromAbroad: true,
    employmentType: "full",
    responsibilities: ["Опис вакансії скорочено джерелом — повний текст за посиланням нижче."],
    mustHave: ["Див. оригінальне оголошення"],
    ...
    experience: "Не вказано джерелом",
    education: "Не вказано джерелом",
    skills: ["Копірайтинг", "Редагування"],
    tools: [],
    languages: ["Українська — рідна"],
    salaryMin: 0, salaryMax: 0, currency: "UAH", salaryHidden: true,
    benefits: [],
    startDate: "", deadline: "2026-08-20",
    applyMethod: "external", contactEmail: "", sourceUrl: "https://happymonday.ua/jobs-search/content-copywriting-and-media",
    publishedAt: "2026-07-26", expiresAt: "2026-08-19",
    source: "Happy Monday", direct: false, promoted: false,
    moderationStatus: "approved", active: true,
  },
];
